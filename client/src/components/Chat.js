...
function Chat() {
  ...
  const age_19 = [
    "3분컷 어떻게 생각하시나요?", "예상 할 수 없는 곳(야외 등) vs 집", "이상형의 섹스어필이 되는 곳", "상대방이 혼전순결 vs 상대방이 경험치만렙", "친구의 전 애인이랑 하기 vs 전 애인의 친구랑 하기", "이성을 볼떄 얼굴 VS 몸매"
  ]
  const age_29 = [
    "3cm에 대해 어떻게 생각하시나요?", "강직도 vs 크기 vs 굵기", "빠르게 vs 천천히 vs 랜덤", "아침파 vs 저녁파 vs 언제든", "묶인 상태로있기 vs 상대방을 묶기", "왁싱이돼있는 것 vs 안돼있는 것"
  ]
